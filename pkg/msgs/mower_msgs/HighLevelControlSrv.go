...
const (
    ...
    HighLevelControlSrvReq_COMMAND_S2_LONG uint8 = 5
    HighLevelControlSrvReq_COMMAND_S1_LONG uint8 = 6
...
type HighLevelControlSrvReq struct {
    ...
    msg.Definitions `ros:"uint8 COMMAND_START=1,uint8 COMMAND_HOME=2,uint8 COMMAND_S1=3,uint8 COMMAND_S2=4,uint8 COMMAND_S2_LONG=5,uint8 COMMAND_S1_LONG=6,uint8 COMMAND_RESET_EMERGENCY=254,uint8 COMMAND_DELETE_MAPS=255"`
    Command uint8
}
